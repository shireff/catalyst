    ...
    <form onSubmit={handleSubmit}>
        ...
        fields.map((field) => {
          ...
          return (
            <div key={field.name} className="space-y-2">
              <label
                htmlFor={field.name}
                className="block text-sm my-2 font-medium text-gray-700 dark:text-gray-300"
              >
                {field.label}
              ...
              {field.type === "select" ? (
                ...
                >
                  <div className="relative">
                    <Listbox.Button
                      className="relative w-full py-2 pl-3 pr-10 text-left bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      disabled={loading}
                    >
                  ...
                  <div className="space-y-1 text-center">
                    ...
                    >
                      ...
                      <div className="flex text-sm text-gray-600 dark:text-gray-300">
                        <span className="relative rounded-md font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
      ...
      <div className="flex justify-center mt-3 items-center space-x-4">
        ...
        <Button
          ...
          onClick={closeModal}
          disabled={loading}
          className="bg-gray-400 dark:bg-gray-600 w-full text-white font-bold px-4 py-2 rounded-md"
        >
          Cancel
        </Button>
      </div>
